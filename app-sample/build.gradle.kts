...
android {
    ...
    productFlavors {
        create("dev") {
            dimension = "buildMode"
            applicationId = "hoangnam9194.linkattribution.sample.dev"
        ...
        create("staging") {
            dimension = "buildMode"
            applicationId = "hoangnam9194.linkattribution.sample.staging"
        ...
        create("prod") {
            dimension = "buildMode"
            applicationId = "hoangnam9194.linkattribution.sample.prod"
